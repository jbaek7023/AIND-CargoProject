...
class PlanningGraph():
    ...
    def add_action_level(self, level):
        ...
        self.a_levels.append(action_list)
    ...
    def competing_needs_mutex(self, node_a1: PgNode_a, node_a2: PgNode_a) -> bool:
        ...
        for precond_a1 in node_a1.parents:
            for precond_a2 in node_a2.parents:
                # if one of the precondition of one action is mutex with a precondition of the other action
    ...
    def inconsistent_support_mutex(self, node_s1: PgNode_s, node_s2: PgNode_s):
        ...
        for precond_s1 in node_s1.parents:
            for precond_s2 in node_s2.parents:
                # if there are no actions that could achieve the two literals at the same time
